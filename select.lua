...
function state:enter(previous)
  ...
  self.chartext = "PRESIONA " .. controls:getKey('JUMP') .. " PARA SELECIONAR JUGADOR" 
  self.costtext = "PRESIONA " .. controls:getKey('ATTACK') .. " o " ..controls:getKey('INTERACT') .. " PARA CAMBIAR EN CUSTOME"
  self.randomtext = "PRESIONA " .. controls:getKey('SELECT') .. " PARA TENER EN RANDOM CUSTOME"
end
