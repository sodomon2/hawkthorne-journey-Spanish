...
function state:draw()
  ...
  love.graphics.print('Controles', 198, 101)
  love.graphics.print('Opiones', 198, 131)
  love.graphics.print('Salir al Mapa', 198, 161)
  love.graphics.print('Salir al Menu', 198, 191)
  love.graphics.print('Salir al Desktop', 198, 221)
  love.graphics.setColor( 255, 255, 255, 255 )
  love.graphics.draw(self.arrow, 156, 96 + 30 * self.option)
  local back = controls:getKey("START") .. ": REGRASAR AL JUEGO"
  local howto = controls:getKey("ATTACK") .. " O " .. controls:getKey("JUMP") .. ": SELECIONAR PUNTO"
