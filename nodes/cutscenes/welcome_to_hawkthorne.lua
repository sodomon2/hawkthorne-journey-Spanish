...
function Scene:start(player)
  ...
  script = {
    "Piercinald, en 1980, dijo que los videojuegos, no las toallitas humedas, eran el negocio del futuro.",
    "Hoy en dia, las toallitas humedas se almacenan en todos los supermercados, mientras que en las salas de juegos",
    "Sin embargo, disene este juego para ser jugado a mi muerte por ti y por cualquier cabala de frutas, drogadictos y putas que llames a tus amigos.",
    "Solo un jugador puede ganar.... el primero en alcanzar mi trono en Castle Hawkthorne. Su recompensa, Pierce, sera tu herencia.",
    "Veras, Pierce, resulta que tenias razon. Los videojuegos son importantes. Ha Ha Ha Ha Ha! PEOR HIJO DE LA HISTORIA!",
  }

  self.dialog = dialog.new("Bienvenido a Hawkthorne.", function()
