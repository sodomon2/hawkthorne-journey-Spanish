...
function state:init()
  ...
  self.text = "Este juego utiliza una funcion de autoguardado.\n"..
              "Se ejecutara cada vez que alcance un nuevo nivel o punto de control.\n" ..
              "Tambien puedes guardar manualmente en las opciones si alguna vez tienes prisa.."
